...
public class MazeGenerator {
	...
	public static String[][] generator(String[][] maze2D) {
		...
		while (visitedCells < totalCells) {
			...
			if (Objects.equals(random, "BACKTRACK")) {
	...
	public static String validSpot(String[][] maze2D, Cell current, ArrayList<String> direction) {
		...
		if (Objects.equals(random, "NORTH")) {
			...
			if (((Objects.equals(maze2D[y - 1][x - 2], "#") || Objects.equals(maze2D[y + 1][x - 2], "#"))
					|| (Objects.equals(maze2D[y][x - 3], "#") || Objects.equals(maze2D[y][x - 1], "#")))) {
	...
	public static String convert2D(String[][] maze2D) {
		...
		for (int columnIndex = 0; columnIndex < size; columnIndex++) {
			for (int rowIndex = 0; rowIndex < size; rowIndex++) {
				if (Objects.equals(maze2D[columnIndex][rowIndex], "+")) {
					maze.append("+");
				} else if (Objects.equals(maze2D[columnIndex][rowIndex], "-")) {
					maze.append("---");
				} else if (Objects.equals(maze2D[columnIndex][rowIndex], "|")) {
					maze.append("|");
				} else if (Objects.equals(maze2D[columnIndex][rowIndex], "#") && columnIndex % 2 == 1) {
				...
				} else if (Objects.equals(maze2D[columnIndex][rowIndex], "#") && columnIndex % 2 == 0) {
					// Hash symbol and column is even
					maze.append("   ");
				} else if (Objects.equals(maze2D[columnIndex][rowIndex], "S") || Objects.equals(maze2D[columnIndex][rowIndex], "E")) {
					maze.append("   ");
				} else if (Objects.equals(maze2D[columnIndex][rowIndex], " ") && columnIndex % 2 == 1 && rowIndex % 2 == 0) {
	...
	public static String DFSValid(String[][] maze2D, Cell current, ArrayList<String> direction) {
		...
		if (random == "NORTH") {
			...
			if (!Objects.equals(maze2D[y - 1][x], " ")) {
			...
			if (!Objects.equals(maze2D[y][x + 1], " ")) {
	...
	public static ArrayList<String> BFSValid(String[][] maze2D, Cell current) {
		...
		} else if (!Objects.equals(maze2D[y - 1][x], " ") || !Objects.equals(maze2D[y - 2][x], " ")) {
			// System.out.println("Do not go NORTH because there is a wall");
			direction.remove("NORTH");
		}
		// Removes EAST
		...
		} else if (!Objects.equals(maze2D[y][x + 1], " ") || !Objects.equals(maze2D[y][x + 2], " ")) {
			// System.out.println("Do not go EAST because there is a wall");
			direction.remove("EAST");
		}
		// Removes SOUTH
	 ...
	 */
	public static void hashList(String[][] maze2D) {
		int size = (maze2D.length - 1) / 2;
		...
		for (int columnIndex = 0; columnIndex < maze2D.length; columnIndex++) {
			for (int rowIndex = 0; rowIndex < maze2D.length; rowIndex++) {
				if (!(Objects.equals(maze2D[columnIndex][rowIndex], "+") || Objects.equals(maze2D[columnIndex][rowIndex], "-")
						|| Objects.equals(maze2D[columnIndex][rowIndex], "|") || Objects.equals(maze2D[columnIndex][rowIndex], "#"))) {
					maze2D[columnIndex][rowIndex] = " ";
				}
			}
		}
		...
		for (int columnIndex = 0; columnIndex < size; columnIndex++) {
			for (int rowIndex = 0; rowIndex < size; rowIndex++) {
				if (Objects.equals(maze2D[columnIndex][rowIndex], "+")) {
					...
					// Hash symbol and column is even
					maze.append(" # ");
				} else if (Objects.equals(maze2D[columnIndex][rowIndex], "S") || maze2D[columnIndex][rowIndex] == "E") {
					maze.append("   ");
				} else if (Objects.equals(maze2D[columnIndex][rowIndex], " ") && columnIndex % 2 == 1 && rowIndex % 2 == 0) {
					// Spacing for the wall
					maze.append(" ");
